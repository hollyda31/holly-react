...
function Bash() {
	return (
		<div className='learningBody'>
			...
			<h1>Coding Wiki BASH Page</h1>
			<p>These are some of the bookmarks I have to help me with BASH.</p>
			<h2>Bookmarks & Resources</h2>
			<ul>
				<li>
				...
				<li>
					<a href='https://www.shellcheck.net'>ShellCheck</a> - This is a
					tool designed for testing out and finding bugs in your Shell
					script.
				</li>
			</ul>
		</div>
